...
declare module 'next' { const x: any; export = x; } // eslint-disable-line @typescript-eslint/no-explicit-any
declare module 'next/*' { const x: any; export = x; } // eslint-disable-line @typescript-eslint/no-explicit-any
declare module 'next/app' { const x: any; export = x; }
declare module 'next/router' { const x: any; export = x; }
declare module 'next/link' { const x: any; export = x; }
declare module 'react-icons/fa' { export const FaClock: any; export const FaCheck: any; export const FaCheckDouble: any; }
declare module 'clsx' { export default function clsx(...args: any[]): string; } // eslint-disable-line @typescript-eslint/no-explicit-any
