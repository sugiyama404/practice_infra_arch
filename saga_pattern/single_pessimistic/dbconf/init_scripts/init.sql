...
('book-123', 100, 0, 5, 200, '2024-09-01 09:00:00'),
('book-456', 5, 0, 2, 10, '2024-08-15 14:00:00'),  -- 決済失敗テスト用（在庫あり）
('book-789', 100, 0, 8, 200, '2024-09-10 11:00:00'),
('book-101', 3, 0, 3, 30, '2024-09-05 16:00:00'),  -- 在庫不足テスト用（少ないまま）
('book-202', 100, 0, 5, 200, '2024-09-08 10:30:00');
